...
import { Separator } from '@web/ui/components/layout/dividers/separator';
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from '@web/ui/components/overlays/tooltip';
...
const sidebarMenuButtonVariants = cva(
  'cursor-pointer text-muted-foreground peer/menu-button flex w-full items-center gap-2'
  + ' overflow-hidden'
  + ' rounded-md p-2'
  + ' text-left'
  + ' text-sm font-light outline-hidden ring-sidebar-ring transition-[width,height,padding]'
  + ' hover:bg-surface-hover'
  + ' active:bg-surface-active'
  + ' disabled:pointer-events-none disabled:opacity-50'
  + ' group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none'
  + ' aria-disabled:opacity-50 data-[active=true]:font-medium'
  + ' data-[active=true]:text-sidebar-accent data-[state=open]:hover:bg-surface-hover'
  + ' data-[state=open]:hover:text-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
        default: '',
        outline:
          'bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-surface-hover'
