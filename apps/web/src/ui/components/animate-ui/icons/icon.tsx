...
import type { HTMLMotionProps, LegacyAnimationControls, SVGMotionProps, UseInViewOptions, Variants } from 'motion/react';
...
import type { WithAsChild } from '@web/ui/components/animate-ui/primitives/animate/slot';

import { useIsInView } from '@web/lib/hooks/use-is-in-view';
import { cn } from '@web/lib/utils/index';
import { Slot } from '@web/ui/components/animate-ui/primitives/animate/slot';
...
function AnimateIcon({
  ...
  return (
    <AnimateIconContext
      // eslint-disable-next-line react/no-unstable-context-value -- stable dependencies
      value={{
        controls,
