...
import { Button, buttonVariants } from '@web/ui/components/atoms';
...
// Extracted components to fix react/no-nested-component-definitions
...
function CalendarChevron({
  ...
  if (orientation === 'up') {
    return <ChevronLeftIcon className={cn('size-4 rotate-90', className)} {...props} />;
  }
