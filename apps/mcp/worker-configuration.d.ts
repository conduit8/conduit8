/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 18bdcf48217a4e1e8088eb6469e794e7)
// Runtime types generated with workerd@1.20251011.0 2025-09-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Conduit8MCP";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		BACKEND_BASE_URL: "https://preview.conduit8.dev" | "https://conduit8.dev";
		COOKIE_ENCRYPTION_KEY: "<Add-Preview-Cookie-Secret>" | "<Add-Prod-Cookie-Secret>";
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").Conduit8MCP>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKEND_BASE_URL" | "COOKIE_ENCRYPTION_KEY">> {}
}
